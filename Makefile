...
CXXFLAGS+=-I. -I/opt/vc/include -I/usr/include/boost -I/opt/vc/include/interface/vcos/pthreads -I/opt/vc/include/interface/vmcs_host/linux -D_REENTRANT
